...
- [x] Task 4: Fault State Machine with Structured Recovery
- [x] Task 5: Event-Driven Telemetry and Live Blynk Dashboard
- [x] Task 6: Enterprise Blynk Analytics and Decision Dashboard
